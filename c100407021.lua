...
function s.regop(e,tp,eg,ep,ev,re,r,rp)
	for tc in aux.Next(eg) do
		...
		elseif tc:IsCode(73879377) then
			Duel.RegisterFlagEffect(tc:GetControler(),id+100,0,0,0)
		end
	end
end
...
function s.aclimit(e,re,tp)
	return Duel.IsExistingMatchingCard(s.acfilter,e:GetHandlerPlayer(),LOCATION_REMOVED,0,1,nil,re:GetHandler():GetCode())
end
