...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,id+100,0x1fc,TYPES_TOKEN,2000,2000,6,RACE_WYRM,ATTRIBUTE_WATER) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(tp,id+100,0x1fc,TYPES_TOKEN,2000,2000,6,RACE_WYRM,ATTRIBUTE_WATER) then return end
