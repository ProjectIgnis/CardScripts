...
s.listed_names={1050355,38267552}
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsCode,1050355),tp,LOCATION_FZONE,LOCATION_FZONE,1,nil,tp) 
