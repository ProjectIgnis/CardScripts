...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if Duel.IsExistingTarget(s.filter,tp,0,LOCATION_ONFIELD,1,nil)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.DiscardHand(tp,s.filter2,1,1,REASON_EFFECT+REASON_DISCARD)>0 and tc:IsRelateToEffect(e) and tc:IsFaceup() then
