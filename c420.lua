...
function Card.IsAlligator(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x502) or c:IsFusionCode(table.unpack(s.OCGAlligator))
	else
		return c:IsSetCard(0x502) or c:IsCode(table.unpack(s.OCGAlligator))
	end
end
...
function Card.IsAngel(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x154a) or c:IsFusionSetCard(0xef) or c:IsFusionCode(table.unpack(s.OCGAngel))
	else
		return c:IsSetCard(0x154a) or c:IsSetCard(0xef) or c:IsCode(table.unpack(s.OCGAngel))
	end
end
...
function Card.IsAnti(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x503) or c:IsFusionCode(id+10085072,59839761,43583400)
	else
		return c:IsSetCard(0x503) or c:IsCode(id+10085072,59839761,43583400)
	end
end
...
function Card.IsAssassin(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x504) or c:IsFusionCode(table.unpack(s.OCGAssassin))
	else
		return c:IsSetCard(0x504) or c:IsCode(table.unpack(s.OCGAssassin))
	end
end
...
function Card.IsBattleguard(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x2509) or c:IsFusionCode(table.unpack(s.OCGBattleguard))
	else
		return c:IsSetCard(0x2509) or c:IsCode(table.unpack(s.OCGBattleguard))
	end
end
...
function Card.IsButterfly(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x50c) or c:IsFusionCode(table.unpack(s.OCGButterfly))
	else
		return c:IsSetCard(0x50c) or c:IsCode(table.unpack(s.OCGButterfly))
	end
end
...
s.OCGPhantomButterfly={
	63630268
}
function Card.IsPhantomButterfly(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x150c) or c:IsFusionSetCard(0x6a) or c:IsFusionCode(table.unpack(s.OCGPhantomButterfly))
	else
		return c:IsSetCard(0x150c) or c:IsSetCard(0x6a) or c:IsCode(table.unpack(s.OCGPhantomButterfly))
	end
end
...
function Card.IsCat(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x50e) or c:IsFusionCode(table.unpack(s.OCGCat))
	else
		return c:IsSetCard(0x50e) or c:IsCode(table.unpack(s.OCGCat))
	end
end
...
function Card.IsDice(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x514) or c:IsFusionCode(table.unpack(s.OCGDice))
	else
		return c:IsSetCard(0x514) or c:IsCode(table.unpack(s.OCGDice))
	end
end
-- Dog ドッグ 
...
function Card.IsDog(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x516) or c:IsFusionCode(table.unpack(s.OCGDog))
	else
		return c:IsSetCard(0x516) or c:IsCode(table.unpack(s.OCGDog))
	end
end
...
function Card.IsDoll(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x517) or c:IsFusionSetCard(0x9d) or c:IsFusionCode(table.unpack(s.OCGDoll))
	else
		return c:IsSetCard(0x517) or c:IsSetCard(0x9d) or c:IsCode(table.unpack(s.OCGDoll))
	end
end
...
function Card.IsDrone(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x581) or c:IsFusionCode(table.unpack(s.OCGDrone))
	else
		return c:IsSetCard(0x581) or c:IsCode(table.unpack(s.OCGDrone))
	end
end
...
function Card.IsDruid(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x8c) or c:IsFusionCode(table.unpack(s.OCGDruid))
	else
		return c:IsSetCard(0x8c) or c:IsCode(table.unpack(s.OCGDruid))
	end
end
...
function Card.IsEarth(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x51a) or c:IsFusionCode(table.unpack(s.OCGEarth))
	else
		return c:IsSetCard(0x51a) or c:IsCode(table.unpack(s.OCGEarth))
	end
end
...
function Card.IsEarthbound(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x151a) or c:IsFusionSetCard(0x21) or c:IsFusionCode(table.unpack(s.OCGEarthbound))
	else
		return c:IsSetCard(0x151a) or c:IsSetCard(0x21) or c:IsCode(table.unpack(s.OCGEarthbound))
	end
end
...
function Card.IsElf(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x51b) or c:IsFusionSetCard(0xe4) or c:IsFusionCode(table.unpack(s.OCGElf))
	else
		return c:IsSetCard(0x51b) or c:IsSetCard(0xe4) or c:IsCode(table.unpack(s.OCGElf))
	end
end
...
s.OCGFairy={
	...
	86937530,55623480,id+10022648,42921475,20315854,45939611,
	6979239
}
function Card.IsFairy(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x51d) or c:IsFusionCode(table.unpack(s.OCGFairy))
	else
		return c:IsSetCard(0x51d) or c:IsCode(table.unpack(s.OCGFairy))
	end
end
...
function Card.IsForest(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x51f) or c:IsFusionCode(table.unpack(s.OCGForest))
	else
		return c:IsSetCard(0x51f) or c:IsCode(table.unpack(s.OCGForest))
	end
end
...
function Card.IsFossil(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x512) or c:IsFusionCode(table.unpack(s.OCGFossil))
	else
		return c:IsSetCard(0x512) or c:IsCode(table.unpack(s.OCGFossil))
	end
end
...
function Card.IsGorgonic(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x522) or c:IsFusionCode(table.unpack(s.OCGGorgonic))
	else
		return c:IsSetCard(0x522) or c:IsCode(table.unpack(s.OCGGorgonic))
	end
end
-- Goyo ゴヨウ 
...
function Card.IsGoyo(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x523) or c:IsFusionCode(table.unpack(s.OCGGoyo))
	else
		return c:IsSetCard(0x523) or c:IsCode(table.unpack(s.OCGGoyo))
	end
end
...
function Card.IsHand(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x527) or c:IsFusionCode(table.unpack(s.OCGHand))
	else
		return c:IsSetCard(0x527) or c:IsCode(table.unpack(s.OCGHand))
	end
end
...
function Card.IsHeavyIndustry(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x529) or c:IsFusionCode(table.unpack(s.OCGHeavyIndustry))
	else
		return c:IsSetCard(0x529) or c:IsCode(table.unpack(s.OCGHeavyIndustry))
	end
end
...
function Card.IsHell(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x567) or c:IsFusionCode(table.unpack(s.OCGHell))
	else
		return c:IsSetCard(0x567) or c:IsCode(table.unpack(s.OCGHell))
	end
end
...
function Card.IsHunder(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x565) or c:IsFusionCode(table.unpack(s.OCGHunder))
	else
		return c:IsSetCard(0x565) or c:IsCode(table.unpack(s.OCGHunder))
	end
end
...
function Card.IsInu(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x52a) or c:IsFusionCode(table.unpack(s.OCGInu))
	else
		return c:IsSetCard(0x52a) or c:IsCode(table.unpack(s.OCGInu))
	end
end
...
function Card.IsIvy(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x52b) or c:IsFusionCode(table.unpack(s.OCGIvy))
	else
		return c:IsSetCard(0x52b) or c:IsCode(table.unpack(s.OCGIvy))
	end
end
...
function Card.IsJester(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x52c) or c:IsFusionCode(table.unpack(s.OCGJester))
	else
		return c:IsSetCard(0x52c) or c:IsCode(table.unpack(s.OCGJester))
	end
end
...
s.OCGKing={
	...
	4179849,71411377,5901497,58477767,19254117,33950246,514id+10091,16509093,93016201,26586849,56058888,72405967,
...
function Card.IsKing(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x52f) or c:IsFusionSetCard(0xf8) or c:IsFusionSetCard(0x81) or c:IsFusionSetCard(0xda) or c:IsFusionCode(table.unpack(s.OCGKing))
	else
		return c:IsSetCard(0x52f) or c:IsSetCard(0xf8) or c:IsSetCard(0x81) or c:IsSetCard(0xda) or c:IsCode(table.unpack(s.OCGKing))
	end
end
...
s.OCGKnight={
	24435369,83678433,1412158,85651167,89494469,39303359,36151751,14553285,95291684,350id+10053,
	71341529,66516792,18036057,652362,72837335,19353570,24291651,64788463,92821268,5id+1004071,
	35950025,11287364,49217579,30936186,33413638,21843307,10375182,85827713,58383100,62873545,
	55291359,32696942,86952477,9603356,78700060,51126152,4436id7,90876561,60410769,15653824,
...
function Card.IsKnight(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x530) or c:IsFusionSetCard(0x1047) or c:IsFusionSetCard(0x9c) or c:IsFusionSetCard(0xc8) 
			or c:IsFusionCode(table.unpack(s.OCGKnight))
	else
		return c:IsSetCard(0x530) or c:IsSetCard(0x1047) or c:IsSetCard(0x9c) or c:IsSetCard(0xc8) or c:IsCode(table.unpack(s.OCGKnight))
	end
end
...
s.OCGKoala={
	...
	id+129512,69579761,1371589,87685879,7243511,71759912,
}
function Card.IsKoala(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x531) or c:IsFusionCode(table.unpack(s.OCGKoala))
	else
		return c:IsSetCard(0x531) or c:IsCode(table.unpack(s.OCGKoala))
	end
end
...
function Card.IsLamp(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x532) or c:IsFusionCode(table.unpack(s.OCGLamp))
	else
		return c:IsSetCard(0x532) or c:IsCode(table.unpack(s.OCGLamp))
	end
end
...
function Card.IsLineMonster(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x564) or c:IsFusionCode(table.unpack(s.OCGLineMonster))
	else
		return c:IsSetCard(0x564) or c:IsCode(table.unpack(s.OCGLineMonster))
	end
end
...
function Card.IsMantis(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x535) or c:IsFusionCode(table.unpack(s.OCGMantis))
	else
		return c:IsSetCard(0x535) or c:IsCode(table.unpack(s.OCGMantis))
	end
end
...
function Card.IsNeko(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x538) or c:IsFusionCode(table.unpack(s.OCGNeko))
	else
		return c:IsSetCard(0x538) or c:IsCode(table.unpack(s.OCGNeko))
	end
end
...
function Card.IsN39Utopia(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x539) or c:IsFusionCode(table.unpack(s.OCGN39Utopia))
	else
		return c:IsSetCard(0x539) or c:IsCode(table.unpack(s.OCGN39Utopia))
	end
end
...
function Card.IsCN39UtopiaRay(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x1539) or c:IsFusionCode(table.unpack(s.OCGCN39UtopiaRay))
	else
		return c:IsSetCard(0x1539) or c:IsCode(table.unpack(s.OCGCN39UtopiaRay))
	end
end
-- Number S 
-- ＳＮｏ.
...
function Card.IsNumberS(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x2048) or c:IsFusionCode(table.unpack(s.OCGNumberS))
	else
		return c:IsSetCard(0x2048) or c:IsCode(table.unpack(s.OCGNumberS))
	end
end
...
function Card.IsNumeron(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x53a) or c:IsFusionCode(table.unpack(s.OCGNumeron))
	else
		return c:IsSetCard(0x53a) or c:IsCode(table.unpack(s.OCGNumeron))
	end
end
...
s.OCGPixie={
	...
	90925163,58753372,44125452,42921475,id+10022648,55623480,
	86937530,45425051,28290705,19684740,68401546,73507661,
	4179255
}
function Card.IsPixie(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x53e) or c:IsFusionCode(table.unpack(s.OCGPixie))
	else
		return c:IsSetCard(0x53e) or c:IsCode(table.unpack(s.OCGPixie))
	end
end
...
function Card.IsPriestess(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x53f) or c:IsFusionCode(table.unpack(s.OCGPriestess))
	else
		return c:IsSetCard(0x53f) or c:IsCode(table.unpack(s.OCGPriestess))
	end
end
...
function Card.IsPuppet(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x540) or c:IsFusionSetCard(0x83) or c:IsFusionSetCard(0x152c) or c:IsFusionCode(table.unpack(s.OCGPuppet))
	else
		return c:IsSetCard(0x540) or c:IsSetCard(0x83) or c:IsSetCard(0x152c) or c:IsCode(table.unpack(s.OCGPuppet))
	end
end
...
function Card.IsRaccoon(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x542) or c:IsFusionCode(table.unpack(s.OCGRacoon))
	else
		return c:IsSetCard(0x542) or c:IsCode(table.unpack(s.OCGRacoon))
	end
end
...
function Card.IsRed(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x543) or c:IsFusionSetCard(0x3b) or c:IsFusionSetCard(0x1045) or c:IsFusionCode(table.unpack(s.OCGRed))
	else
		return c:IsSetCard(0x543) or c:IsSetCard(0x3b) or c:IsSetCard(0x1045) or c:IsCode(table.unpack(s.OCGRed))
	end
end
...
s.OCGRose={
	49674183,96470883,31986288,41160533,51085303,41201555,752id+10099,
	...
	55326322,93302695,94145683,76442616,8585id+14,53027855,12213463,
	26118970,80196387
}

function Card.IsRose(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x544) or c:IsFusionCode(table.unpack(s.OCGRose))
	else
		return c:IsSetCard(0x544) or c:IsCode(table.unpack(s.OCGRose))
	end
end
...
function Card.IsSeal(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x545) or c:IsFusionCode(table.unpack(s.OCGSeal))
	else
		return c:IsSetCard(0x545) or c:IsCode(table.unpack(s.OCGSeal))
	end
end
...
function Card.IsShaman(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x546) or c:IsFusionCode(table.unpack(s.OCGShaman))
	else
		return c:IsSetCard(0x546) or c:IsCode(table.unpack(s.OCGShaman))
	end
end
...
function Card.IsShark(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x547) or c:IsFusionCode(table.unpack(s.OCGShark))
	else
		return c:IsSetCard(0x547) or c:IsCode(table.unpack(s.OCGShark))
	end
end
...
function Card.IsShining(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x548) or c:IsFusionCode(table.unpack(s.OCGShining))
	else
		return c:IsSetCard(0x548) or c:IsCode(table.unpack(s.OCGShining))
	end
end
...
function Card.IsSky(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x54a) or c:IsFusionSetCard(0xf6) or c:IsFusionSetCard(0x3042) or c:IsFusionCode(table.unpack(s.OCGSky))
	else
		return c:IsSetCard(0x54a) or c:IsSetCard(0xf6) or c:IsSetCard(0x3042) or c:IsCode(table.unpack(s.OCGSky))
	end
end
...
-- Revival Jam
s.OCGSlime={
	31709826,46821314,3918345,26905245,5600127,4id+1006713,
	72291412,21770261
}
function Card.IsSlime(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x54b) or c:IsFusionCode(table.unpack(s.OCGSlime))
	else
		return c:IsSetCard(0x54b) or c:IsCode(table.unpack(s.OCGSlime))
	end
end
...
function Card.IsSphere(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x54c) or c:IsFusionCode(table.unpack(s.OCGSphere))
	else
		return c:IsSetCard(0x54c) or c:IsCode(table.unpack(s.OCGSphere))
	end
end
...
-- Dragon Statue
s.OCGStatue={
	7id+1009824,3129635,49514333,9197735
}
function Card.IsStatue(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x550) or c:IsFusionCode(table.unpack(s.OCGStatue))
	else
		return c:IsSetCard(0x550) or c:IsCode(table.unpack(s.OCGStatue))
	end
end
...
function Card.IsStone(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x551) or c:IsFusionCode(table.unpack(s.OCGStone))
	else
		return c:IsSetCard(0x551) or c:IsCode(table.unpack(s.OCGStone))
	end
end
...
function Card.IsTachyon(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x555) or c:IsFusionCode(table.unpack(s.OCGTachyon))
	else
		return c:IsSetCard(0x555) or c:IsCode(table.unpack(s.OCGTachyon))
	end
end
...
function Card.IsTachyonDragon(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x1555) or c:IsFusionCode(table.unpack(s.OCGTachyonDragon))
	else
		return c:IsSetCard(0x1555) or c:IsCode(table.unpack(s.OCGTachyonDragon))
	end
end
...
function Card.IsToy(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x559) or c:IsFusionCode(table.unpack(s.OCGToy))
	else
		return c:IsSetCard(0x559) or c:IsCode(table.unpack(s.OCGToy))
	end
end
...
function Card.IsV(c,fbool)
	...
	if fbool then
		return c:IsFusionSetCard(0x55a) or c:IsFusionSetCard(0x41) or c:IsFusionSetCard(0x5008) or c:IsFusionCode(table.unpack(s.OCGV))
	else
		return c:IsSetCard(0x55a) or c:IsSetCard(0x41) or c:IsSetCard(0x5008) or c:IsCode(table.unpack(s.OCGV))
	end
end
...
function Card.IsW(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x56b) or c:IsFusionSetCard(0xf0) or c:IsFusionSetCard(0x7e) or c:IsFusionCode(table.unpack(s.OCGW))
	else
		return c:IsSetCard(0x56b) or c:IsSetCard(0xf0) or c:IsSetCard(0x7e) or c:IsCode(table.unpack(s.OCGW))
	end
end
...
function Card.IsWhite(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x55d) or c:IsFusionCode(table.unpack(s.OCGWhite))
	else
		return c:IsSetCard(0x55d) or c:IsCode(table.unpack(s.OCGWhite))
	end
end
...
function Card.IsX(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x56c) or c:IsFusionSetCard(0x1073) or c:IsFusionSetCard(0x100d) or c:IsFusionCode(table.unpack(s.OCGX))
	else
		return c:IsSetCard(0x56c) or c:IsSetCard(0x1073) or c:IsSetCard(0x100d) or c:IsCode(table.unpack(s.OCGX))
	end
end
...
function Card.IsY(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x56d) or c:IsFusionSetCard(0xc1) or c:IsFusionCode(table.unpack(s.OCGY))
	else
		return c:IsSetCard(0x56d) or c:IsSetCard(0xc1) or c:IsCode(table.unpack(s.OCGY))
	end
end
...
function Card.IsYubel(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x561)  or c:IsFusionCode(table.unpack(s.OCGYubel))
	else
		return c:IsSetCard(0x561) or c:IsCode(table.unpack(s.OCGYubel))
	end
end
...
function Card.IsZ(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x56e) or c:IsFusionSetCard(0x7e) or c:IsFusionCode(table.unpack(s.OCGZ))
	else
		return c:IsSetCard(0x56e) or c:IsSetCard(0x7e) or c:IsCode(table.unpack(s.OCGZ))
	end
end
...
function Card.IsInfinity(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x562) or c:IsFusionCode(table.unpack(s.OCGInfinity))
	else
		return c:IsSetCard(0x562) or c:IsCode(table.unpack(s.OCGInfinity))
	end
end
...
9870120,228id+126,23064604,23689697,26205777,26822796,
...
function Card.IsMonarch(c,fbool)
	if fbool then
		return c:IsFusionSetCard(0x571) or c:IsFusionSetCard(0xbe) or c:IsFusionCode(table.unpack(s.OCGMonarch))
	else
