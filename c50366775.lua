...
function s.cfilter(c,tc,tp)
	return c:IsType(TYPE_LINK) and not c:IsCode(tc:GetSummonCode(nil,SUMMON_TYPE_LINK,tp))
end
...
function s.thfilter(c)
	return c:IsRace(RACE_CYBERSEE) and c:IsLevelAbove(5) and c:IsAbleToHand()
end
