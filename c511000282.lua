...
function s.filter(c,e,tp,tid)
	return (c:GetReason()&REASON_BATTLE)~=0 and c:GetTurnID()==tid
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(s.filter,tp,LOCATION_GRAVE,LOCATION_GRAVE,1,nil,e,tp,tid) end
