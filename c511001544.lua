...
function s.initial_effect(c)
	...
	e0:SetCondition(aux.FConditionMix(true,true,s.fil1,s.fil1,s.fil1))
	e0:SetOperation(aux.FOperationMix(true,true,s.fil1,s.fil1,s.fil1))
	c:RegisterEffect(e0)
	local e0a=e0:Clone()
	e0a:SetDescription(aux.Stringid(4006,14))
	e0a:SetCondition(aux.FConditionMix(true,true,s.fil1,s.fil2))
	e0a:SetOperation(aux.FOperationMix(true,true,s.fil1,s.fil2))
