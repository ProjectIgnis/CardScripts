...
s.listed_names={3790062,100000581,111011002,511000580,511002068,511002164,93238626}
s.xyz_number=65
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local choice=Duel.SelectOption(tp,aux.Stringid(id,1),aux.Stringid(id,0))
