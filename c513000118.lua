...
function s.initial_effect(c)
	...
	e4:SetTarget(function(e,c)return c:GetFlagEffect(id1)>0 and c:GetOriginalLevel()<5 end)
	e4:SetCondition(s.ntcon)
	e4:SetValue(SUMMON_TYPE_NORMAL)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	e5:SetTarget(function(e,c)return c:GetFlagEffect(id1)>0 and c:GetOriginalLevel()>4 and c:GetOriginalLevel()<8 end)
	e5:SetCondition(s.ttcon1)
	e5:SetOperation(s.ttop1)
	e5:SetValue(SUMMON_TYPE_ADVANCE)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
	e6:SetTarget(function(e,c)return c:GetFlagEffect(id1)>0 and c:GetOriginalLevel()>7 end)
