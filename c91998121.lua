...
function s.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcCode3(c,62651957,65622692,64500000,true,true)
	--spsummon condition
...
s.material_count=3
s.material={62651957,65622692,64500000}
...
function s.spcon(e,c)
	...
	local g1=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_ONFIELD,0,nil,62651957)
	local g2=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_ONFIELD,0,nil,65622692)
	local g3=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_ONFIELD,0,nil,64500000)
	if #g1==0 or #g2==0 or #g3==0 then return false end
