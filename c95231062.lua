...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsRace,RACE_FISH+RACE_AQUA+RACE_SEASERPENT),tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler())
end
