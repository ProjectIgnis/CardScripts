...
DUEL_MODE_MR5   = (DUEL_PZONE | DUEL_EMZONE | DUEL_FSX_MMZONE | DUEL_TRAP_MONSTERS_NOT_USE_ZONE | DUEL_TRIGGER_ONLY_IN_LOCATION | DUEL_SPSUMMON_ONCE_OLD_NEGATE | DUEL_CANNOT_SUMMON_OATH_OLD)
--Activity counters
