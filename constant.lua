...
POS_FACEUP_DEFENCE		=POS_FACEUP_DEFENSE --(some random cards)
...
EFFECT_COUNT_CODE_SINGLE		=0x40000000		--同一张卡的多个效果公共使用次数
--特殊选项
...
--commonly used cards
CARD_BLUEEYES_SPIRIT		=CARD_BLUEEYES_SPIRIT
CARD_SUMMON_GATE			=CARD_SUMMON_GATE
CARD_POLYMERIZATION			=CARD_POLYMERIZATION
CARD_NECROVALLEY			=CARD_NECROVALLEY
CARD_SANCTUARY_SKY			=CARD_SANCTUARY_SKY
CARD_UMI					=CARD_UMI
CARD_DARK_MAGICIAN			=CARD_DARK_MAGICIAN
CARD_DARK_MAGICIAN_GIRL		=CARD_DARK_MAGICIAN_GIRL
CARD_BLUEEYES_W_DRAGON		=CARD_BLUEEYES_W_DRAGON
CARD_GALAXYEYES_P_DRAGON	=CARD_GALAXYEYES_P_DRAGON
CARD_CYBER_DRAGON			=CARD_CYBER_DRAGON
CARD_REDEYES_B_DRAGON		=CARD_REDEYES_B_DRAGON
CARD_STROMBERG				=CARD_STROMBERG
CARD_NEOS					=CARD_NEOS
CARD_ORPHEGEL_BABEL			=CARD_ORPHEGEL_BABEL
CARD_SUMMONED_SKULL			=CARD_SUMMONED_SKULL
CARD_HARPIE_LADY			=CARD_HARPIE_LADY
CARD_HARPIE_LADY_SISTERS	=CARD_HARPIE_LADY_SISTERS
CARD_SALAMANGREAT_SANCTUARY =CARD_SALAMANGREAT_SANCTUARY
CARD_PSYFRAME_LAMBDA		=CARD_PSYFRAME_LAMBDA
CARD_PSYFRAME_DRIVER		=CARD_PSYFRAME_DRIVER
CARD_FIRE_FIST_EAGLE		=CARD_FIRE_FIST_EAGLE
CARD_EVIL_EYE_SELENE		=44133040
CARD_ASSAULT_MODE			=CARD_ASSAULT_MODE
CARD_VIJAM					=CARD_VIJAM
