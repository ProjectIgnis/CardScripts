...
DUEL_REPOS_AFTER_CONTROL_SWITCH    = 0x80000000
...
DUEL_MODE_GOAT  = (DUEL_MODE_MR1 | DUEL_USE_TRAPS_IN_NEW_CHAIN | DUEL_6_STEP_BATLLE_STEP | DUEL_TRIGGER_WHEN_PRIVATE_KNOWLEDGE | DUEL_EQUIP_NOT_SENT_IF_MISSING_TARGET | DUEL_0_ATK_DESTROYED | DUEL_STORE_ATTACK_REPLAYS | DUEL_SINGLE_CHAIN_IN_DAMAGE_SUBSTEP | DUEL_REPOS_AFTER_CONTROL_SWITCH)
...
CARD_FOSSIL_FUSION          = 100266011 --To be updated on release
...
CARD_NEOS                   = 89943723
CARD_NUMERON_NETWORK        = 100266026 --To be updated on release
