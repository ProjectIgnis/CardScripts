...
Auxiliary.IsMaterialListCode            = deprecated_alias("Card.HasListedCodeAsMaterial")
Auxiliary.IsMaterialListSetCard         = deprecated_alias("Card.HasListedArchetypeAsMaterial")
Auxiliary.IsArchetypeCodeListed         = deprecated_alias("Card.HasListedCodeWithArchetype")
Auxiliary.IsCodeListed                  = deprecated_alias("Card.HasListedCode")
Auxiliary.IsCardTypeListed              = deprecated_alias("Card.HasListedCardType")
Auxiliary.HasListedSetCode              = deprecated_alias("Card.HasListedArchetype")
