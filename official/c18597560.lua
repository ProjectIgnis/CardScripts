...
function s.filter(c,e,tp,mc)
	return c:IsType(TYPE_FUSION) and c:HasListedArchetypeAsMaterial(0x1093) and Duel.GetLocationCountFromEx(tp,tp,mc,c)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
