...
function s.thfilter(c)
	return c:IsMonster() and c:HasListedCode(CARD_SANCTUARY_SKY) and c:IsAbleToHand()
end
...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsReason(REASON_BATTLE) and c:HasListedCode(CARD_SANCTUARY_SKY)
end
