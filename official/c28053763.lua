...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	--lizard check
	Auxiliary.addTempLizardCheck(e:GetHandler(),tp)
...
function s.tkop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerCanSpecialSummonMonster(1-tp,id+1,0,TYPES_TOKEN,300,300,1,RACE_MACHINE,ATTRIBUTE_EARTH,POS_FACEUP_ATTACK) then return end
