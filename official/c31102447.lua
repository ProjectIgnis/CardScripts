...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Return 1 "Amazoness" monster to the hand or Deck
...
function s.thfilter(c)
	return c:IsMonster() and c:IsSetCard(SET_AMAZONESS) and not c:IsCode(id) and (c:IsAbleToHand() or c:IsAbleToDeck())
end
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.ToHandOrElse(tc,tp, function(c) return tc:IsAbleToDeck() end,
