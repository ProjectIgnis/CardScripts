...
function s.initial_effect(c)
	--Destroy this card, and if you do, Special Summon 2 "Meklord Army" monsters from your Deck in Defense Position
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetMZoneCount(tp,c)>=2
...
function s.regop(e,tp,eg,ep,ev,re,r,rp)
	--Inflict 100 damage to your opponent for each "Meklord" monster you control
