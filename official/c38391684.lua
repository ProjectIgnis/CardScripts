...
function s.initial_effect(c)
	...
	e1:SetCondition(function()
		return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.ListsCode,CARD_ATLANTIS_CITY_OF_THE_SEA_DRAGON),0,LOCATION_MZONE,LOCATION_MZONE,1,nil)
	end)
	e1:SetValue(-1)
	c:RegisterEffect(e1)
	...
	e2:SetCode(CARD_ATLANTIS_CITY_OF_THE_SEA_DRAGON)
