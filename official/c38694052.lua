...
function s.initial_effect(c)
	...
	--Destroy 1 face-up card on the field it, and if you destroyed a monster, you can make 1 face-up monster you control gain ATK equal to the destroyed monster's original Level/Rank x 300
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.Destroy(tc,REASON_EFFECT)>0 and tc:IsPreviousLocation(LOCATION_MZONE) 
		...
		--Increase its ATK by the destroyed monster's original Level/Rank x 300
