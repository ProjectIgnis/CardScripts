...
function s.initial_effect(c)
	--Special Summon 1 Level 4 "Constellar" monster from your hand in face-up Defense Position
...
function s.spfilter(c,e,tp)
	return c:IsLevel(4) and c:IsSetCard(SET_CONSTELLAR) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
