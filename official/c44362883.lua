...
function s.initial_effect(c)
	--Activate
	local e1=Fusion.CreateSummonEff(c,aux.FilterBoolFunction(Card.HasListedCodeAsMaterial,CARD_ALBAZ),nil,s.fextra,nil,nil,nil,2,nil,nil,nil,nil,nil,nil,s.extratg)
	e1:SetCost(s.cost)
