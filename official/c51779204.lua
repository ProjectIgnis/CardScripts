...
function s.initial_effect(c)
	...
	e2:SetCondition(function() return (Duel.IsAbleToEnterBP() or (Duel.IsBattlePhase() and not Duel.IsPhase(PHASE_BATTLE))) and aux.StatChangeDamageStepCondition() end)
