...
function s.costfilter(c,ec)
	return c:IsSetCard(SET_GLADIATOR) and not c:IsCode(id) and c:IsMonster() and c:IsAbleToGraveAsCost()
end
...
function s.filter(c,e,tp)
	return not c:IsCode(id) and c:IsSetCard(SET_GLADIATOR) and c:IsCanBeSpecialSummoned(e,102,tp,false,false)
end
