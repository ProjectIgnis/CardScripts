...
function s.thcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffectLabel(CARD_REVERSAL_OF_FATE)==COIN_HEADS and c:IsRelateToBattle()
...
function s.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:GetFlagEffectLabel(CARD_REVERSAL_OF_FATE)==COIN_TAILS and (re:IsHasType(EFFECT_TYPE_ACTIVATE) or re:IsActiveType(TYPE_MONSTER))
end
