...
function s.initial_effect(c)
	--Activate
	local e1=Fusion.CreateSummonEff(c,aux.FilterBoolFunction(Card.IsMaterialListSetCard,0x3b),nil,s.fextra,nil,nil,s.stage2,nil,nil,nil,nil,nil,nil,nil,s.extratg)
...
function s.ffilter(c,fc,sumtype,tp)
	...
	elseif set then
		res=res or (c:IsSetCard(0x3b,fc,sumtype,tp) and fc:IsMaterialListSetCard(0x3b))
	else
		return false
	end
	return res
