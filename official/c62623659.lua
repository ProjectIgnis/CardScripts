...
function s.thfilter(c)
	return c:IsAbleToHand() and ((c:IsType(TYPE_MONSTER) and (c:IsSetCard(0x107e) or c:IsSetCard(0x207e))) or (c:IsSpell() and (c:IsSetCard(0x7e) or c:IsSetCard(0x95) or c:IsSetCard(0x15d))) or c:IsType(TYPE_TRAP) and c:IsSetCard(0x7e))
end
