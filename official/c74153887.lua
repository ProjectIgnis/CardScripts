...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingMatchingCardGoat(s.filter,tp,LOCATION_DECK,0,1,nil)
		or Duel.IsExistingTarget(s.filter,tp,LOCATION_GRAVE,0,1,nil) end
	local op=0
	if Duel.IsExistingMatchingCardGoat(s.filter,tp,LOCATION_DECK,0,1,nil)
