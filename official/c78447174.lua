...
--Anime version scripted by pyrQ, updated by Yamato
local s,id=GetID()
...
function s.sscon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsSetCard,0x14a),tp,LOCATION_MZONE,0,1,nil)
end
...
function s.cfilter(c,tp)
	return c:IsFaceup() and c:IsCode(id) and c:IsControler(tp)
end
