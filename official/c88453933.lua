...
function s.tgfilter(c)
	return c:IsSetCard(SET_DRAGONMAID) and not c:IsCode(id) and c:IsAbleToGrave()
end
...
function s.spfilter(c,e,tp)
	return c:GetLevel()==8 and c:IsSetCard(SET_DRAGONMAID) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
