...
function s.filter(c)
	return ( ( (c:IsSetCard(0xdd) and c:IsType(TYPE_MONSTER)) ) or ( (aux.IsCodeListed(c,CARD_BLUEEYES_W_DRAGON) or aux.IsCodeListed(c,23995346)) and c:IsSpellTrap() and not c:IsCode(id) ) ) 
		and c:IsAbleToHand()
end
