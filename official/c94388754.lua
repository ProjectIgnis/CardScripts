...
function s.initial_effect(c)
	c:EnableReviveLimit()
	--Must first be Special Summoned (from your hand) by Tributing 1 "Flower Cardian" monster, except "Flower Cardian Clover with Boar"
	...
	c:RegisterEffect(e0)
	--Draw 1 card, and if you do, show it, then, if it is a "Flower Cardian" monster, you can destroy 1 monster your opponent controls
