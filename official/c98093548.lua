...
function s.cfilter(c)
	return c:IsFaceup() and (c:IsSpell() or c:IsType(TYPE_TRAP)) and c:IsSetCard(0x7c) and c:IsAbleToGraveAsCost()
end
...
function s.shfilter(c)
	return c:IsAbleToDeck() and c:IsSetCard(0x7c) and (c:IsSpell() or c:IsType(TYPE_TRAP))
end
