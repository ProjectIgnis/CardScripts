...
function s.filter(c,e,tp)
	return c:IsSetCard(0x244) and c:IsLinkMonster() and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp,c)
end
function s.spfilter(c,e,tp,fc)
	local zone=fc:GetFreeLinkedZone()&0x1f
	return c:IsSetCard(0x244) and c:IsLinkMonster() and c:IsLink(1)
