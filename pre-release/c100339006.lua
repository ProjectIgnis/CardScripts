--憑依覚醒ー大稲荷火
--Awakened-Possessed - Great Inari Fire
--Scripted by Naim
local s,id=GetID()
...
function s.thfilter(c)
	return c:IsAbleToHand() and (c:IsSetCard(0x2245) or (c:IsSetCard(0xc0) and c:IsType(TYPE_SPELL+TYPE_TRAP)))
end
