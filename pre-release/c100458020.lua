...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--If Summoned this way: You can target 1 Spell/Trap your opponent controls; place it on the bottom of the Deck
...
function s.tdtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsOnField() and chkc:IsSpellTrap() and chkc:IsAbleToDeck() end
