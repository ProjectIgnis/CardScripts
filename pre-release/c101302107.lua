...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsSetCard({SET_DD,SET_DARK_CONTRACT}) and chkc:IsLocation(LOCATION_ONFIELD) and chkc:IsControler(tp) and chkc:IsFaceup() end
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	--You can conduct 1 Pendulum Summon of a "D/D" monster(s) in addition to your Pendulum Summon
...
function s.penfilter(c,e,tp,lscale,rscale)
	return c:IsSetCard(SET_DD) and Pendulum.Filter(c,e,tp,lscale,rscale)
end
