...
function Fusion.AddSummonEff(c,fusfilter,matfilter,desc,extrafil,extraop,gc,stage2,exactcount,location,chkf)
	...
	e1:SetTarget(Fusion.SummonEffTG(fusfilter,matfilter,extrafil,extraop,gc,stage2,exactcount,location,chkf))
	e1:SetOperation(Fusion.SummonEffOP(fusfilter,matfilter,extrafil,extraop,gc,stage2,exactcount,location,chkf))
	c:RegisterEffect(e1)
	return e1
end
...
function Fusion.SummonEffTG(fusfilter,matfilter,extrafil,extraop,gc,stage2,exactcount,location,chkf)
...
function Fusion.SummonEffOP(fusfilter,matfilter,extrafil,extraop,gc,stage2,exactcount,location,chkf)
	return	function(e,tp,eg,ep,ev,re,r,rp)
				...
				for _,ce in ipairs(extraeffs) do
					...
					local mf=ce:GetValue()
					local sg2=Duel.GetMatchingGroup(Fusion.SummonEffFilter,tp,location,0,nil,aux.AND(mf,fusfilter or aux.TRUE),e,tp,mg2,type(gc)=="function" and gc(e,tp,eg,ep,ev,re,r,rp,chk) or gc,chkf)
					if #sg2 > 0 then
