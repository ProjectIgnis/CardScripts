...
local LEGEND_LIST={CARD_BLUEEYES_W_DRAGON,CARD_DARK_MAGICIAN,CARD_REDEYES_B_DRAGON,CARD_SUMMONED_SKULL,CARD_JINZO,
	CARD_MONSTER_REBORN,CARD_POLYMERIZATION,48766543,32012841,11091375,49881766,14898066,97127906,15025844,40921744,
	36354007,61505339,78193831,81480460,37721209,18318842,70050374,80304126,88975532,15960641,41089128,52097679,
	72892473,70368879,79759861,95281259,79571449,53129443,37630732,90928333,74848038,55144522,97169186,81191584,
	67169062,19613556,4206964,53582587,56120475,44095762,62279055,77754944}
-- Returns if a card is a Legend. Can be updated if a GetOT function is added to the core
function Card.IsLegend(c)
	return c:IsCode(table.unpack(LEGEND_LIST))
end