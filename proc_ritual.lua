...
function(filter,_type,lv,extrafil,extraop,matfilter,stage2,location,forcedselection)
	return	function(e,tp,eg,ep,ev,re,r,rp,chk)
				...
				if chk==0 then
					...
					return Duel.IsExistingMatchingCard(Ritual.Filter,tp,location,0,1,nil,filter,_type,e,tp,mg,mg2,forcedselection,lv)
				end
...
function(filter,_type,lv,extrafil,extraop,matfilter,stage2,location,forcedselection,customoperation,specificmatfilter)
	return	function(e,tp,eg,ep,ev,re,r,rp)
				...
				local tg=Duel.SelectMatchingCard(tp,Ritual.Filter,tp,location,0,1,1,nil,filter,_type,e,tp,mg,mg2,forcedselection,lv)
				if #tg>0 then
