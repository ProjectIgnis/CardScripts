...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg>0 and Duel.ChangePosition(g,POS_FACEUP_DEFENSE,POS_FACEDOWN_DEFENSE,POS_FACEUP_ATTACK,POS_FACEUP_ATTACK)>0  and Duel.SelectYesNo(tp,aux.Stringid(id,0)) then
