...
function s.cfilter(c,tp)
	return c:GetPreviousAttackOnField()>=1500 and c:GetPreviousAttributeOnField()==ATTRIBUTE_DARK and c:GetPreviousRaceOnField()==RACE_GALAXY
...
function s.filter(c,e,tp)
	return c:IsRace(RACE_GALAXY) and c:IsAttribute(ATTRIBUTE_DARK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
