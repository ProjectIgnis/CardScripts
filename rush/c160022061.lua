...
function s.initial_effect(c)
	...
	e0:SetValue(160207050)
	c:RegisterEffect(e0)
	--Make Sea Serpent gain 800 ATK
...
function s.filter(c)
	return c:IsFaceup() and c:IsRace(RACE_SEASERPENT) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsAttackPos()
end
