...
function s.spfilter(c,e,tp)
	return c:IsDefenseBelow(1300) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
...
function s.filter(c)
	return c:IsFaceup() and c:IsRace(RACE_PYRO) and c:IsCanChangePositionRush()
end
