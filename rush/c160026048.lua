--謎の飛行植物は実在した！！
--The Mysterious Flying Plants Are Real!!
...
function s.thfilter(c)
	return c:IsLevelBelow(4) and c:IsRace(RACE_PLANT) and c:IsAttribute(ATTRIBUTE_WIND) and c:IsAbleToHand()
end
...
function s.spfilter(c,e,tp)
	return c:IsLevelAbove(6) and c:IsRace(RACE_PLANT) and c:IsAttribute(ATTRIBUTE_WIND) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
