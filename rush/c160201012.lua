...
function s.filter1(c,tp)
	return c:IsFaceup() and c:HasLevel() and c:CanGetPiercingRush() and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_MZONE,0,1,c,c:GetLevel()) and not c:IsMaximumModeSide()
end
