...
function s.thfilter(c)
	return ((c:IsRace(RACE_CYBERSE) and c:IsType(TYPE_MAXIMUM)) or (c:IsRace(RACE_FIEND) and c:IsAttribute(ATTRIBUTE_DARK) and c:IsAttack(0) and c:IsDefenseAbove(2400))) and c:IsAbleToHand()
end
