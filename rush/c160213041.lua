--抑竜コアトルステルン
--Suppressaurus Coatlustern
--Scripted by YoshiDuels
local s,id=GetID()
function s.initial_effect(c)
	--Special Summon 1 Neos from GY
...
function s.spfilter(c,e,tp)
	return c:IsLevel(4) and c:IsRace(RACE_DINOSAUR) and c:IsDefense(1200) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
