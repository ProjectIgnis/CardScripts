--魔除けの聖水が欲しいです！
--I Need Holy Water to Ward Off Evil Spirits!
...
s.listed_names={160217018,160217019}
function s.ritualfil(c)
	return c:IsCode(160217018,160217019)
end
...
function s.desfilter(c)
	return c:IsFaceup() and c:IsLevelBelow(6) and c:IsRace(RACE_WARRIOR|RACE_FIEND)
end
