...
function s.filter(c,e,tp)
	return c:IsRace(RACE_SPELLCASTER) and c:IsDefense(1500) and c:IsAttack(500,1900) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(function(_,c) return (c:IsLevelAbove(9)) end)
