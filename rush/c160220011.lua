--魔竜デビル・ドラゴン
--Koumori Dragon the Magical Dragon
...
function s.spfilter(c,e,tp)
	return c:IsLevel(4) and c:IsRace(RACE_DRAGON) and c:IsType(TYPE_EFFECT) and c:IsAttack(1500) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
