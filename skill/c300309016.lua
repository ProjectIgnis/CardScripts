...
--s.listed_series={SET_HARPIE_LADY_SISTERS} (to be implemented when the setcode list is updated)
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetRange(0x5f)
	e1:SetTarget(function(e,c) return c:IsFaceup() and c:IsMonster() and c:IsCode(12206212) end)
