...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.filter),tp,0x13,0,nil,31930787,e,tp)
	local g2=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.filter),tp,0x13,0,nil,100000057,e,tp)
	local g3=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.filter),tp,0x13,0,nil,100000058,e,tp)
	local g4=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.filter),tp,0x13,0,nil,100000059,e,tp)
	local g5=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.filter),tp,0x13,0,nil,100000060,e,tp)
