...
function s.initial_effect(c)
	...
	dme1:SetTarget(aux.TargetBoolFunction(Card.IsType,TYPE_TRAP))
...
function s.dmcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(s.filter),tp,0,LOCATION_ONFIELD,1,nil) and Duel.GetDeckMaster(tp) and Duel.GetDeckMaster(tp):IsOriginalCode(id)
end
