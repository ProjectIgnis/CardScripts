...
function s.initial_effect(c)
	...
	dme1:SetCondition(function(e) return Duel.GetDeckMaster(e:GetOwnerPlayer()) and Duel.GetDeckMaster(e:GetOwnerPlayer()):IsOriginalCode(id) end)
	dme1:SetTarget(aux.TargetBoolFunction(Card.IsAttribute,ATTRIBUTE_LIGHT))
	dme1:SetValue(0x10001)
