...
if not AnimeArchetype then
    ...
    function Card.IsAlligator(c,fbool)
        if fbool then
            return c:IsSetCard(0x502,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGAlligator))
        else
    ...
    function Card.IsAngel(c,fbool)
        if fbool then
            return c:IsSetCard(0x154a,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xef,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGAngel))
        else
    ...
    function Card.IsAnti(c,fbool)
        if fbool then
            return c:IsSetCard(0x503,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(52085072,59839761,43583400)
        else
    ...
    function Card.IsAssassin(c,fbool)
        if fbool then
            return c:IsSetCard(0x504,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGAssassin))
        else
    ...
    function Card.IsAstral(c,fbool)
        if fbool then
            return c:IsSetCard(0x505,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(37053871,45950291)
        else
    ...
    function Card.IsAtlandis(c,fbool)
        if fbool then
            return c:IsSetCard(0x506,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(9161357,6387204)
        else
    ...
    function Card.IsBarian(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x509,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(67926903,59479050)
        else
    ...
    function Card.IsBarians(c,fbool)
        if fbool then
            return c:IsSetCard(0x1509,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(47660516,92365601)
        else
    ...
    function Card.IsBattleguard(c,fbool)
        if fbool then
            return c:IsSetCard(0x2509,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGBattleguard))
        else
    ...
    function Card.IsBlackwingTamer(c,fbool)
        if fbool then
            return c:IsSetCard(0x2033,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(81983656)
        else
    ...
    function Card.IsButterfly(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x50c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGButterfly))
        else
    ...
    function Card.IsPhantomButterfly(c,fbool)
        if fbool then
            return c:IsSetCard(0x150c,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x6a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGPhantomButterfly))
        else
    ...
    function Card.IsCat(c,fbool)
        if fbool then
            return c:IsSetCard(0x50e,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGCat))
        else
    ...
    function Card.IsCelestial(c,fbool)
        if fbool then
            return c:IsSetCard(0x254a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(69865139,25472513)
        else
    ...
    function Card.IsChampion(c,fbool)
        if fbool then
            return c:IsSetCard(0x152f,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(82382815)
        else
    ...
    function Card.IsClear(c,fbool)
        if fbool then
            return c:IsSetCard(0x510,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(97811903,82044279,33900648)
        else
    ...
    function Card.IsComicsHero(c,fbool)
        if fbool then
            return c:IsSetCard(0x511,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(77631175,13030280)
        else
    ...
    function Card.IsCubicSeed(c,fbool)
        if fbool then
            return c:IsSetCard(0x10e3,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(CARD_VIJAM)
        else
    ...
    function Card.IsDart(c,fbool)
        if fbool then
            return c:IsSetCard(0x513,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(43061293)
        else
    ...
    function Card.IsDice(c,fbool)
        if fbool then
            return c:IsSetCard(0x514,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGDice))
        else
    ...
    function Card.IsDog(c,fbool)
        if fbool then
            return c:IsSetCard(0x516,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGDog))
        else
    ...
    function Card.IsDoll(c,fbool)
        if fbool then
            return c:IsSetCard(0x517,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x9d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGDoll))
        else
    ...
    function Card.IsDrone(c,fbool)
        if fbool then
            return c:IsSetCard(0x581,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGDrone))
        else
    ...
    function Card.IsDruid(c,fbool)
        if fbool then
            return c:IsSetCard(0x8c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGDruid))
        else
    ...
    function Card.IsDyson(c,fbool)
        if fbool then
            return c:IsSetCard(0x519,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(1992816,32559361)
        else
    ...
    function Card.IsEarth(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x51a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGEarth))
        else
    ...
    function Card.IsEarthbound(c,fbool)
        if fbool then
            return c:IsSetCard(0x151a,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x21,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGEarthbound))
        else
    ...
    function Card.IsElf(c,fbool)
        if fbool then
            return c:IsSetCard(0x51b,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xe4,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGElf))
        else
    ...
    function Card.IsEmissaryOfDarkness(c,fbool)
        if fbool then
            return c:IsSetCard(0x51c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(44330098,44330099)
        else
    ...
    function Card.IsFairy(c,fbool)
        if fbool then
            return c:IsSetCard(0x51d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGFairy))
        else
    ...
    function Card.IsForest(c,fbool)
        if fbool then
            return c:IsSetCard(0x51f,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGForest))
        else
    ...
    function Card.IsFossil(c,fbool)
        if fbool then
            return c:IsSetCard(0x512,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGFossil))
        else
    ...
    function Card.IsGemKnightLady(c,fbool)
        if fbool then
            return c:IsSetCard(0x3047,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(47611119,19355597)
        else
    ...
    function Card.IsGorgonic(c,fbool)
        if fbool then
            return c:IsSetCard(0x522,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGGorgonic))
        else
    ...
    function Card.IsGoyo(c,fbool)
        if fbool then
            return c:IsSetCard(0x523,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGGoyo))
        else
    ...
    function Card.IsGranel(c,fbool)
        if fbool then
            return c:IsSetCard(0x524,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(2137678,4545683)
        else
    ...
    function Card.IsHand(c,fbool)
        if fbool then
            return c:IsSetCard(0x527,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGHand))
        else
    ...
    function Card.IsHeavyIndustry(c,fbool)
        if fbool then
            return c:IsSetCard(0x529,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGHeavyIndustry))
        else
    ...
    function Card.IsHell(c,fbool)
        if fbool then
            return c:IsSetCard(0x567,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGHell))
        else
    ...
    function Card.IsHeraldic(c,fbool)
        if fbool then
            return c:IsSetCard(0x566,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x76,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(23649496,47387961)
        else
    ...
    function Card.IsHunder(c,fbool)
        if fbool then
            return c:IsSetCard(0x565,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGHunder))
        else
    ...
    function Card.IsInu(c,fbool)
        if fbool then
            return c:IsSetCard(0x52a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGInu))
        else
    ...
    function Card.IsIvy(c,fbool)
        if fbool then
            return c:IsSetCard(0x52b,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGIvy))
        else
    ...
    function Card.IsJester(c,fbool)
        if fbool then
            return c:IsSetCard(0x52c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGJester))
        else
    ...
    function Card.IsJutte(c,fbool)
        if fbool then
            return c:IsSetCard(0x52d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(60410769)
        else
    ...
    function Card.IsKing(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x52f,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xf8,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x81,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xda,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGKing))
        else
    ...
    function Card.IsKoala(c,fbool)
        if fbool then
            return c:IsSetCard(0x531,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGKoala))
        else
    ...
    function Card.IsLamp(c,fbool)
        if fbool then
            return c:IsSetCard(0x532,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGLamp))
        else
    ...
    function Card.IsLandstar(c,fbool)
        if fbool then
            return c:IsSetCard(0x533,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(3573512,83602069)
        else
    ...
    function Card.IsLineMonster(c,fbool)
        if fbool then
            return c:IsSetCard(0x564,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGLineMonster))
        else
    ...
    function Card.IsMantis(c,fbool)
        if fbool then
            return c:IsSetCard(0x535,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGMantis))
        else
    ...
    function Card.IsMelodiousSongtress(c,fbool)
        if fbool then
            return c:IsSetCard(0x209b,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(14763299,62895219)
        else
    ...
    function Card.IsMotor(c,fbool)
        if fbool then
            return c:IsSetCard(0x537,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(82556058)
        else
    ...
    function Card.IsNeko(c,fbool)
        if fbool then
            return c:IsSetCard(0x538,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGNeko))
        else
    ...
    function Card.IsN39Utopia(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x539,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGN39Utopia))
        else
    ...
    function Card.IsCN39UtopiaRay(c,fbool)
        if fbool then
            return c:IsSetCard(0x1539,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGCN39UtopiaRay))
        else
    ...
    function Card.IsNumberS(c,fbool)
        if fbool then
            return c:IsSetCard(0x2048,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGNumberS))
        else
    ...
    function Card.IsNumeron(c,fbool)
        if fbool then
            return c:IsSetCard(0x53a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGNumeron))
        else
    ...
    function Card.IsPapillon(c,fbool) 
        if fbool then
            return c:IsSetCard(0x53c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(16366944)
        else
    ...
    function Card.IsParasite(c,fbool)
        if fbool then
            return c:IsSetCard(0x53d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(49966595,6205579)
        else
    ...
    function Card.IsPixie(c,fbool)
        if fbool then
            return c:IsSetCard(0x53e,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGPixie))
        else
    ...
    function Card.IsPriestess(c,fbool)
        if fbool then
            return c:IsSetCard(0x53f,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGPriestess))
        else
    ...
    function Card.IsPuppet(c,fbool)
        if fbool then
            return c:IsSetCard(0x540,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x83,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x152c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGPuppet))
        else
    ...
    function Card.IsRaccoon(c,fbool)
        if fbool then
            return c:IsSetCard(0x542,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGRacoon))
        else
    ...
    function Card.IsRed(c,fbool)
        if fbool then
            return c:IsSetCard(0x543,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x3b,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x1045,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGRed))
        else
    ...
    function Card.IsRose(c,fbool)
        if fbool then
            return c:IsSetCard(0x544,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGRose))
        else
    ...
    function Card.IsSeal(c,fbool)
        if fbool then
            return c:IsSetCard(0x545,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGSeal))
        else
    ...
    function Card.IsShaman(c,fbool)
        if fbool then
            return c:IsSetCard(0x546,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGShaman))
        else
    ...
    function Card.IsShark(c,fbool)
        if fbool then
            return c:IsSetCard(0x547,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGShark))
        else
    ...
    function Card.IsShining(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x548,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGShining))
        else
    ...
    function Card.IsSkiel(c,fbool)
        if fbool then
            return c:IsSetCard(0x549,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(31930787,75733063)
        else
    ...
    function Card.IsSky(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x54a,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xf6,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x3042,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGSky))
        else
    ...
    function Card.IsSlime(c,fbool)
        if fbool then
            return c:IsSetCard(0x54b,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGSlime))
        else
    ...
    function Card.IsSphere(c,fbool)
        if fbool then
            return c:IsSetCard(0x54c,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGSphere))
        else
    ...
    function Card.IsSpirit(c,fbool)
        if fbool then
            return (c:IsSetCard(0x54e,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(CARD_BLUEEYES_SPIRIT))
        else
    ...
    function Card.IsStarship(c,fbool)
        if fbool then
            return c:IsSetCard(0x54f,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(15458892,10389142)
        else
    ...
    function Card.IsStatue(c,fbool)
        if fbool then
            return c:IsSetCard(0x550,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGStatue))
        else
    ...
    function Card.IsStone(c,fbool)
        if fbool then
            return c:IsSetCard(0x551,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGStone))
        else
    ...
    function Card.IsTachyon(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x555,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGTachyon))
        else
    ...
    function Card.IsTachyonDragon(c,fbool)
        if fbool then
            return c:IsSetCard(0x1555,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGTachyonDragon))
        else
    ...
    function Card.IsToy(c,fbool)
        if fbool then
            return c:IsSetCard(0x559,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGToy))
        else
    ...
    function Card.IsV(c,fbool)
        ...
        if fbool then
            return c:IsSetCard(0x55a,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x41,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x5008,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGV))
        else
    ...
    function Card.Is_V_(c,fbool)
        if fbool then
            return c:IsSetCard(0x155a,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(33725002,66970002,13536606,13536607)
        else
    ...
    function Card.IsW(c,fbool)
        if fbool then
            return c:IsSetCard(0x56b,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xf0,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x7e,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGW))
        else
    ...
    function Card.IsWhite(c,fbool)
        if fbool then
            return c:IsSetCard(0x55d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGWhite))
        else
    ...
    function Card.IsWisel(c,fbool)
        if fbool then
            return c:IsSetCard(0x560,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(68140974,39648965)
        else
    ...
    function Card.IsX(c,fbool)
        if fbool then
            return c:IsSetCard(0x56c,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x1073,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x100d,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGX))
        else
    ...
    function Card.IsY(c,fbool)
        if fbool then
            return c:IsSetCard(0x56d,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xc1,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGY))
        else
    ...
    function Card.IsYomi(c,fbool)
        if fbool then
            return c:IsSetCard(0x563,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(12538374,51534754)
        else
    ...
    function Card.IsYubel(c,fbool)
        if fbool then
            return c:IsSetCard(0x561,nil,SUMMON_TYPE_FUSION)  or c:IsFusionCode(table.unpack(AnimeArchetype.OCGYubel))
        else
    ...
    function Card.IsZ(c,fbool)
        if fbool then
            return c:IsSetCard(0x56e,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0x7e,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGZ))
        else
    ...
    function Card.IsInfinity(c,fbool)
        if fbool then
            return c:IsSetCard(0x562,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGInfinity))
        else
    ...
    function Card.IsMonarch(c,fbool)
        if fbool then
            return c:IsSetCard(0x571,nil,SUMMON_TYPE_FUSION) or c:IsSetCard(0xbe,nil,SUMMON_TYPE_FUSION) or c:IsFusionCode(table.unpack(AnimeArchetype.OCGMonarch))
        else
