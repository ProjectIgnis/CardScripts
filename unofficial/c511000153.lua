...
s.listed_names={CARD_KURIBOH,100278001,100278002,100278003,100278004,100278005}
function s.rescon(sg,e,tp,mg)
	return aux.ChkfMMZ(1)(sg,e,tp,mg) and sg:IsExists(s.chk,1,nil,sg,Group.CreateGroup(),100278002,100278003,100278004,CARD_KURIBOH)
end
...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g1=Duel.GetMatchingGroup(s.cfilter,tp,LOCATION_ONFIELD,0,nil,100278002)
	local g2=Duel.GetMatchingGroup(s.cfilter,tp,LOCATION_ONFIELD,0,nil,100278003)
	local g3=Duel.GetMatchingGroup(s.cfilter,tp,LOCATION_ONFIELD,0,nil,100278004)
