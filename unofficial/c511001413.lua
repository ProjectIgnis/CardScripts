...
s.listed_names={511001412,511001414} --"Tom Thumb", "Globerman"
function s.costfilter(c,tid,ft,tp)
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroupCost(tp,s.costfilter,1,false,nil,nil,tid,ft,tp) end
