...
function s.initial_effect(c)
	...
	e3:SetOperation(s.halveopplpop)
	c:RegisterEffect(e3)
	...
	e4:SetOperation(s.halvebothlpop)
	c:RegisterEffect(e4)
...
function s.halveopplpop(e,tp,eg,ep,ev,re,r,rp)
	Duel.SetLP(1-tp,Duel.GetLP(1-tp)/2)
end
function s.halvebothlpop(e,tp,eg,ep,ev,re,r,rp)
