...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local mg1=Duel.GetFusionMaterial(tp):Filter(s.filter3,nil)
		local mg2=Duel.GetFusionMaterial(1-tp):Filter(s.filter3,nil)
		mg1:Merge(mg2)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg2=Duel.GetFusionMaterial(1-tp):Filter(s.filter4,nil,e)
	mg1:Merge(mg2)
