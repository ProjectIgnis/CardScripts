...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectReleaseGroupCost(tp,Card.IsCode,1,1,false,nil,nil,89839552)
	Duel.Release(g,REASON_COST)
end
function s.filter(c,e,tp)
	return (c:IsCode(77590412) or c:IsCode(15001619) or c:IsCode(511009178) or c:IsCode(511009179)) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
