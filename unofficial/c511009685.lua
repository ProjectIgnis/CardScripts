...
function s.initial_effect(c)
	--link summon
	c:EnableReviveLimit()
	Link.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,SET_GOUKI),2,2)
	--negate
...
function s.spfilter(c,e,tp)
	return c:IsLinkMonster() and c:IsSetCard(SET_GOUKI) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
