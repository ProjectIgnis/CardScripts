...
s.listed_names={90140980,511027667}
function s.cfilter(c,ft,tp)
	return c:IsCode(90140980) and (ft>0 or (c:GetSequence()<5 and c:IsControler(tp))) and (c:IsFaceup() or c:IsControler(tp))
end
...
function s.spfilter(c,e,tp)
	return c:IsCode(511027667) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
end
