...
local s, id = GetID()
local ADJUST_COUNT_MEAN = 50 --average number of adjusts between challenges
local ADJUST_COUNT_VAR = 10 --number of adjusts between challenges can be mean +- this
local DEBUG_FORCE_CHALLENGE = 22 --if not 0, will force a specific challenge for testing
