...
function s.spcheck(sg,tp)
	return aux.ReleaseCheckMMZ(sg,tp) and sg:IsExists(s.chk,1,nil,sg,Group.CreateGroup(),24530661,810000091)
end
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,Card.IsCode,2,nil,s.spcheck,nil,24530661,810000091) end
	local sg=Duel.SelectReleaseGroupCost(tp,Card.IsCode,2,2,nil,s.spcheck,nil,24530661,810000091)
